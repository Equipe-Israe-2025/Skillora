    ...
    try {
      ...
      const [etudiant, auteur] = await Promise.all([
        sequelize.models.Etudiant.findOne({
          ...
          include: [sequelize.models.Utilisateur]
        }),
      ...
      if (etudiant && auteur) {
        ...
        await sequelize.models.Notification.create({
          ...
          contenu: `Vous avez été signalé par ${typeAuteur} (${auteur.prenom} ${auteur.nom}) pour: ${signalement.description}. Veuillez consulter votre encadrant pour plus d'informations.`,
          lu: false,
          date: new Date(),
          Id_U: etudiant.Id_U
        });
